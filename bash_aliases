...
alias bits=' vim ~/.bits'
alias vg=' nvim ~/.dotfiles/vim/snippets/gleam.snippets'
alias vh=' nvim ~/.dotfiles/vim/snippets/haskell.snippets'
alias ve=' nvim ~/.dotfiles/vim/snippets/elm.snippets'
alias vp=' nvim ~/.dotfiles/vim/snippets/purescript.snippets'
alias vex=' nvim ~/.dotfiles/vim/snippets/elixir.snippets'
alias vr=' nvim ~/.dotfiles/vim/snippets/ruby.snippets'
alias vmd=' nvim ~/.dotfiles/vim/snippets/markdown.snippets'
alias vrc=' nvim ~/.dotfiles/vimrc'
alias hdf=' ncd ~/.dotfiles'
alias to=' nvim todo'
...
alias memm='mix ecto.migrations'
...
alias mtww='mix test.watch --stale --only wip'
alias imt='iex -S mix test'
alias imtw='iex -S mix test.watch --stale'
...
alias magm='mix ash_postgres.generate_migrations'
